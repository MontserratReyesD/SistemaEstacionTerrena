...
>
  ...
  <div class="container flex items-center justify-between">
    ...
    <div>
      <a href="/">
        <img src="{{asset('/assets/img/logo3.png')}}" style="-webkit-clip-path: inset(5% 5% 15% 5%);" 
                                          class="w-24 lg:w-48" alt="logo image" />
      </a>
    </div>
    ...
    <div class="flex flex-col items-center justify-center lg:flex-row">
      ...
      <div class="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
        ...
        >
          ...
          >
            <p class="font-body text-lg uppercase text-white">LABORATORIO DE INVESTIGACION AEROESPACIAL DE LA UACM</p>
          ...
          >
            ...
            <a href="/" class="pl-4">
            <i
              class="bx bxl-youtube text-2xl text-white hover:text-yellow"
            ></i>
          </a>
          </div>
          <!--
...
<div class="bg-grey-50" id="about">
  <div class="container flex flex-col items-center py-16 md:py-20 lg:flex-row">
    <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
      ...
      >
        Laboratorio de Investigación Aeroespacial de la Universidad Autónoma de la Ciudad de México (UACM)
      </h4>
      <p class="pt-6 font-body leading-relaxed text-grey-20">
        ...
        Con el proposito de crear un espacio en el que los estudiantes de todas las carreras puedan desarrollar
        investigacion en el ambito aeroespacial, desarrollando los conocimientos adquiridos en su formación
        profesional.
      </p>
      <div
      ...
      >
        ...
        >
          ...
          <a href="/" class="pl-4">
            <i
              class="bx bxl-youtube text-2xl text-primary hover:text-yellow"
            ></i>
          </a>
        </div>
      </div>
    ...
    <div>
      <img
          src="{{asset('/assets/img/Equipo.JPG')}}"
  ...
  >
    <div class="group rounded px-8 py-12 shadow hover:bg-primary">
      ...
      <div class="text-center">
        ...
        >
          M.C. Diana Aurora Cruz Hernández
        </h3>
    ...
    <div class="group rounded px-8 py-12 shadow hover:bg-primary">
      ...
      <div class="text-center">
        ...
        <p class="text-grey pt-4 text-sm group-hover:text-white md:text-base">
          Pasante de la carrera Lic. Ingeniería de Software de la Universidad Autónoma de la Ciudad de México 
        </p>
      </div>
      <div
          class="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0"
...
<div class="container py-16 md:py-20" id="contact">
  ...
  <div class="flex flex-col pt-16 lg:flex-row">
    ...
    >
      ...
      <p class="pt-2 text-left font-body font-bold text-primary lg:text-lg">
      San Lorenzo Tezonco, Calle Prolongación San Isidro No. 151, Col. San Lorenzo Tezonco, 
      Alcaldía Iztapalapa, México, CDMX., C.P. 09790.
      </p>
...
<div class="h-72 bg-cover bg-center bg-no-repeat sm:h-64 md:h-72 lg:h-96">
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3765.26867084482!2d-99.06157962586137!3d19.314144444455366!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85ce025ef919d837%3A0x8976a765f69064e3!2sUACM%20San%20Lorenzo%20Tezonco!5e0!3m2!1ses!2smx!4v1687497458615!5m2!1ses!2smx" 
